...
import com.hhp227.knu_minigroup.databinding.FragmentTimetableBinding;
import com.hhp227.knu_minigroup.viewmodel.SemesterTimeTableViewModel;

public class SemesterTimeTableFragment extends Fragment {
    private SemesterTimeTableViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(SemesterTimeTableViewModel.class);
