    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0, id = 0; i < lay.length; i++) { // 10개
            for (int j = 1; j < dayLine.length; j++) { // 6개
                ...
                data[id].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void update_timetable_dig(final int id) {
                        ...
                        putSubject.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                putSubject.setText(null);
                            }});
                        putClassroom.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                putClassroom.setText(null);
                            }});
